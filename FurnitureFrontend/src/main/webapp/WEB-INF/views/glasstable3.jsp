        ...
        <li><a href="CartPage"><span class="glyphicon glyphicon-shopping-cart"></span> Cart</a></li>
         <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="LoginPage">Log Out</a></li></ul>
          </ul>
        </li>
        <li class="dropdown">
...
<p style="font-family: 'Nunito', sans-serif;color:black"><a href="GlasstablePage"><u>Table</u></a>|Dining Table</p>   

   <img src="http://furnitz.com/wp-content/uploads/2015/04/dining-room-appealing-frosted-glass-rectangle-dining-room-tables-with-black-armless-chairs-stainless-steel-legs-with-breakfast-tables-sets-plus-dining-chair-cheerful-modern-tempered-glass-dining-table.jpg" style="width:350px;height:350px" />
  
  <div class="col-sm-6">
          <div class="product-info-box">
            <h1 class="heading-underlined">
              <span class="small-heading accent"></span>
            Rectangle dining room tables with black armless chairs</h1>
            ...
            <div class="tab-content" id="product-tab-content">
              <div role="tabpanel" class="tab-pane active" id="description">              
                <p style="padding: 0 15px;line-height: 160%;">Dining room appealing frosted glass rectangle dining room tables with black armless chairs stainless steel legs with breakfast tables set plus dining chair cheerful modern tempered glass dining table.</p>
  ...
  <p><span style="font-size:36px;font-family: 'Nunito', sans-serif;">  Our Price:</span><span style="font-size: 36px;font-family: 'Peralta', cursive;">Rs.12500</span></p>
...
<p><span style="font-size:20px;font-family:'Nunito'">  You Save:</span><span style="font-size: 20px;font-family:'Nunito';">Rs.2000</span></p>
  ...
  <a href="GlasstablePage"><button type="button" class="btn btn-primary btn-xs">Back</button></a>
  </div>
