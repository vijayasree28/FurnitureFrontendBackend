...
<p style="font-family: 'Nunito', sans-serif;color:black"><a href="ReclinersPage"><u>Table</u></a>|GlassTable</p>   
   ...
   <img src="http://ecx.images-amazon.com/images/I/51DHt1ZOPEL.jpg" style="width:350px;height:350px" />
          ...
          <div class="product-info-box">
            ...
            <div class="tab-content" id="product-tab-content">
              <div role="tabpanel" class="tab-pane active" id="description">              
                <p style="padding: 0 15px;line-height: 160%;">The innovative new Anti-slip backing significantly cuts down on slippage. The protector's style is easier to put on and take off than slipcovers. The water repellant face fabric further protects your furniture from accidents.</p>
                </div>
                </div>
                </div>
                </div>
 ...
 <p><span style="font-size:20px;font-family:'Nunito'">  List Price:</span><span style="font-size: 20px;font-family:'Nunito';text-decoration:line-through">Rs.8500</span></p>
<p><span style="font-size:20px;font-family:'Nunito'">  You Save:</span><span style="font-size: 20px;font-family:'Nunito';">Rs.4500</span></p>
