...
<p style="font-family: 'Nunito', sans-serif;color:black"><a href="Sofa"><u>Sofa</u></a>|Lounger Sofa</p>   
   ...
   <img  src="http://www.homebunch.com/wp-content/uploads/k6.png" style="width:350px;height:350px" />
          ...
          <div class="product-info-box">
            ...
            <div class="tab-content" id="product-tab-content">
              <div role="tabpanel" class="tab-pane active" id="description">              
                <p style="padding: 0 15px;line-height: 160%;">Add a touch of elegance with the sleek and stylish PASSAT. The perfect choice for any type of living room whether it is modern or traditional ,this is sure to fit right in. The box like frame brings in a virtue of compactness. There is no compromise on comfort with its plump cushions and high backed seat.</p>
 ...
 <p><span style="font-size:20px;font-family:'Nunito'">  List Price:</span><span style="font-size: 20px;font-family:'Nunito';text-decoration:line-through">Rs.17990</span></p>
  <p><span style="font-size:20px;font-family:'Nunito'">  You Save:</span><span style="font-size: 20px;font-family:'Nunito';">Rs.3490</span></p>
