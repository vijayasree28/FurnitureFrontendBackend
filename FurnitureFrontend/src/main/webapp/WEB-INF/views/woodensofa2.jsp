        ...
        <li><a href="CartPage"><span class="glyphicon glyphicon-shopping-cart"></span> Cart</a></li>
         <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="LoginPage">Your Out</a></li>
          </ul>
        </li>
        <li class="dropdown">
...
<p style="font-family: 'Nunito', sans-serif;color:black"><a href="SofaPage"><u>Sofa</u></a>|Wooden Sofa</p>   

   <img src="http://img.frbiz.com/nimg/7c/03/3216ace7128cf9b4142392c33064-0x0-0/office_strong_style_color_b82220_sofa_strong_set_cd_3610.jpg" style="width:350px;height:350px" />
  
  <div class="col-sm-6">
          <div class="product-info-box">
            <h1 class="heading-underlined">
              <span class="small-heading accent"></span>
             Wooden Strong Sofaset            </h1>
            ...
            <div class="tab-content" id="product-tab-content">
              <div role="tabpanel" class="tab-pane active" id="description">              
                <p style="padding: 0 15px;line-height: 160%;">Office Style Wooden Strong Sofa set</p>
  ...
  <p><span style="font-size:36px;font-family: 'Nunito', sans-serif;">  Our Price:</span><span style="font-size: 36px;font-family: 'Peralta', cursive;">Rs.16500</span></p>
 <p><span style="font-size:20px;font-family:'Nunito'">  List Price:</span><span style="font-size: 20px;font-family:'Nunito';text-decoration:line-through">Rs.17599</span></p>
  <p><span style="font-size:20px;font-family:'Nunito'">  You Saved:</span><span style="font-size: 20px;font-family:'Nunito';">Rs.1099</span></p>
