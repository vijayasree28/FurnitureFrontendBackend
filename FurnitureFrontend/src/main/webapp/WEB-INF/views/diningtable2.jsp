...
<p style="font-family: 'Nunito', sans-serif;color:black"><a href="#"><u>Table</u></a>|Dining Table</p>   
...
<p><span style="font-size:20px;font-family:'Nunito'">  You Save:</span><span style="font-size: 20px;font-family:'Nunito';">Rs.500</span></p>
  ...
  <a href="DiningtablePage"><button type="button" class="btn btn-primary btn-xs">Back</button></a>
  </div>
