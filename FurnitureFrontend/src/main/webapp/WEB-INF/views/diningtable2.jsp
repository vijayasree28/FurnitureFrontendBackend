...
<p style="font-family: 'Nunito', sans-serif;color:black"><a href="Diningtable"><u>Table</u></a>|Dining Table</p>   

   <img src="http://bestdsgn.com/wp-content/uploads/2015/09/dining-room-stunning-glass-top-dining-room-table-with-cross-wooden-table-base-legs-and-combine-rectangle-glass-on-top-also-white-leather-dining-chair-with-wooden-base-legs-with-also-round-glass-top-d.jpg" style="width:350px;height:350px" />
  
  <div class="col-sm-6">
          <div class="product-info-box">
            <h1 class="heading-underlined">
              <span class="small-heading accent"></span>
            Dining room stunning glass top table </h1>
            ...
            <div class="tab-content" id="product-tab-content">
              <div role="tabpanel" class="tab-pane active" id="description">              
                <p style="padding: 0 15px;line-height: 160%;">Dining room stunning glass top table with cross wooden table base legs and combine rectangle glass on top also white leather dining chair with wooden base legs with also round glasstop.</p>
  ...
  <p><span style="font-size:36px;font-family: 'Nunito', sans-serif;">  Our Price:</span><span style="font-size: 36px;font-family: 'Peralta', cursive;">Rs.14000</span></p>
 <p><span style="font-size:20px;font-family:'Nunito'">  List Price:</span><span style="font-size: 20px;font-family:'Nunito';text-decoration:line-through">Rs.14500</span></p>
<p><span style="font-size:20px;font-family:'Nunito'">  You Save:</span><span style="font-size: 20px;font-family:'Nunito';">Rs.500</span></p>
  ...
  <a href="Diningtable"><button type="button" class="btn btn-primary btn-xs">Back</button></a>
  </div>
