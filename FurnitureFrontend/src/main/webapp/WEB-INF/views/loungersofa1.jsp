...
<h2> Sofa </h2>   
  ...
  <tr>
  <td> 
   <img  src="http://www.yorkshiresofas.com/wp-content/uploads/2015/10/best-sofas-1.jpg" style="width:350px;height:350px" />
  </td>
  <div class="col-sm-6">
          <div class="product-info-box">
            <h1 class="heading-underlined">
              <span class="small-heading accent"></span>
              Mio Leather Lounger Sofa </h1>
            ...
            <div class="tab-content" id="product-tab-content">
              <div role="tabpanel" class="tab-pane active" id="description">              
                <p style="padding: 0 15px;line-height: 160%;">The MIO is perfect sofa to entertain family and guests.
This is left hand facing and is ideal if you want the comfort, style and convenience of a corner sofa. 
This lovely piece is inspired by cool and contemporary style.</p>
                <ul class="features-list">
                  <li><strong>Material :</strong> Fabric</li>
                  <li><strong>Seats :</strong> Comphy Seater</li>
                  <li><strong>Lounger :</strong> Yes</li>
                </ul>
              </div>
  <p style="color:whitesmoke">acd</p>
  <p style="color:whitesmoke">lkj</p>
  ...
  <p><span style="font-size:36px;font-family: 'Nunito', sans-serif;">  Our Price:</span><span style="font-size: 36px;font-family: 'Peralta', cursive;">Rs.14500</span></p>
 <p><span style="font-size:20px;font-family:'Nunito'">  List Price:</span><span style="font-size: 20px;font-family:'Nunito';text-decoration:line-through">Rs.16990</span></p>
  <p><span style="font-size:20px;font-family:'Nunito'">  You Save:</span><span style="font-size: 20px;font-family:'Nunito';">Rs.2490</span></p>
