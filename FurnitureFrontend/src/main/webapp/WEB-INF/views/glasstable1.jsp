...
<p style="font-family: 'Nunito', sans-serif;color:black"><a href="GlasstablePage"><u>Table</u></a>|GlassTable</p>   

   <img src="http://www.wilko.com/content/ebiz/wilkinsonplus/invt/s100013/s100013_l.jpg" style="width:350px;height:350px" />
  
  <div class="col-sm-6">
          <div class="product-info-box">
            <h1 class="heading-underlined">
              <span class="small-heading accent"></span>
             Altra Carson Coffee Table , Black          </h1>
            ...
            <div class="tab-content" id="product-tab-content">
              <div role="tabpanel" class="tab-pane active" id="description">              
                <p style="padding: 0 15px;line-height: 160%;">Center your living room around the Altra Carson Coffee Table for a whole new contemporary look.</p>
  ...
  <p><span style="font-size:36px;font-family: 'Nunito', sans-serif;">  Our Price:</span><span style="font-size: 36px;font-family: 'Peralta', cursive;">Rs.5500</span></p>
 <p><span style="font-size:20px;font-family:'Nunito'">  List Price:</span><span style="font-size: 20px;font-family:'Nunito';text-decoration:line-through">Rs.6500</span></p>
<p><span style="font-size:20px;font-family:'Nunito'">  You Save:</span><span style="font-size: 20px;font-family:'Nunito';">Rs.1000</span></p>
