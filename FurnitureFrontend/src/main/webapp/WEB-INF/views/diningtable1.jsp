...
<p style="font-family: 'Nunito', sans-serif;color:black"><a href="Diningtable"><u>Tables</u></a>|Dining Table</p>   

   <img src="http://dwc4.co.in/Demo/ssr%20interiors/web/images/p14.jpg" style="width:350px;height:350px" />
  
  <div class="col-sm-6">
          <div class="product-info-box">
            <h1 class="heading-underlined">
              <span class="small-heading accent"></span>
             Glass Dining Table </h1>
            ...
            <div class="tab-content" id="product-tab-content">
              <div role="tabpanel" class="tab-pane active" id="description">              
                <p style="padding: 0 15px;line-height: 160%;">.</p>
