...
<p style="font-family: 'Nunito', sans-serif;color:black"><a href="Sofa"><u>Sofa</u></a>|Lounger Sofa</p>   
   ...
   <img  src="http://room-decorating-ideas.com/wp-content/uploads/2013/04/best-sofa-bed-design.jpg" style="width:350px;height:350px" />
          ...
          <div class="product-info-box">
            ...
            <div class="tab-content" id="product-tab-content">
              <div role="tabpanel" class="tab-pane active" id="description">              
                <p style="padding: 0 15px;line-height: 160%;">The perfect choice for any type of living room whether it is modern or traditional.The frame brings in a virtue of compactness.Comfort with its plump cushions and high backed seat.</p>
 ...
 <p><span style="font-size:20px;font-family:'Nunito'">  List Price:</span><span style="font-size: 20px;font-family:'Nunito';text-decoration:line-through">Rs.15499</span></p>
   <p><span style="font-size:20px;font-family:'Nunito'">  You Save:</span><span style="font-size: 20px;font-family:'Nunito';">Rs.999</span></p>
