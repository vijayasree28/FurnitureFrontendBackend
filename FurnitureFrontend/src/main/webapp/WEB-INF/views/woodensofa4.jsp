...
<p style="font-family: 'Nunito', sans-serif;color:black"><a href="SofaPage"><u>Sofa</u></a>|Wooden Sofa</p>   
   ...
   <img src="http://images-cdn.azureedge.net/azure/in-resources/c7d6eae8-e11f-40a7-becc-9393b09b7a9a/Images/ProductImages/Source/10005.jpg" style="width:350px;height:350px" />
  ...
  <p><span style="font-size:36px;font-family: 'Nunito', sans-serif;">  Our Price:</span><span style="font-size: 36px;font-family: 'Peralta', cursive;">Rs.15500</span></p>
 <p><span style="font-size:20px;font-family:'Nunito'">  List Price:</span><span style="font-size: 20px;font-family:'Nunito';text-decoration:line-through">Rs.16599</span></p>
  <p><span style="font-size:20px;font-family:'Nunito'">  You Save:</span><span style="font-size: 20px;font-family:'Nunito';">Rs.1099</span></p>
