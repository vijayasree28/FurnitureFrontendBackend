...
<p style="font-family: 'Nunito', sans-serif;color:black"><a href="GlasstablePage"><u>Table</u></a>|GlassTable</p>   
   ...
   <img src="http://www.furnitureinfashion.net/images/beech-glass-coffee-tables-tokyoBcEx.jpg" style="width:350px;height:350px" />
  
  <div class="col-sm-6">
          <div class="product-info-box">
            <h1 class="heading-underlined">
              <span class="small-heading accent"></span>
             Merax Best Coffee Table with Glass Top, Black       </h1>
            ...
            <div class="tab-content" id="product-tab-content">
              <div role="tabpanel" class="tab-pane active" id="description">              
                <p style="padding: 0 15px;line-height: 160%;">Center your living room around the Merax Best Coffee Table with Glass Top for a whole new contemporary look.</p>
  ...
  <p><span style="font-size:36px;font-family: 'Nunito', sans-serif;">  Our Price:</span><span style="font-size: 36px;font-family: 'Peralta', cursive;">Rs.4500</span></p>
