...
<p style="font-family: 'Nunito', sans-serif;color:black"><a href="Recliners"><u>Table</u></a>|GlassTable</p>   
...
<p><span style="font-size:20px;font-family:'Nunito'">  You Save:</span><span style="font-size: 20px;font-family:'Nunito';">Rs.500</span></p>
  ...
  <a href="Recliners"><button type="button" class="btn btn-primary btn-xs">Back</button></a>
  </div>
