...
<title>www.Furniture.com/recliners</title>
...
<p style="font-family: 'Nunito', sans-serif;color:black"><a href="ReclinersPage"><u>Table</u></a>|GlassTable</p>   

   <img src="http://st.hzcdn.com/simgs/79614d120fe8323f_4-6562/modern-recliner-chairs.jpg" style="width:350px;height:350px" />
          ...
          <div class="product-info-box">
            ...
            <div class="tab-content" id="product-tab-content">
              <div role="tabpanel" class="tab-pane active" id="description">              
                <p style="padding: 0 15px;line-height: 160%;">the Slim Recliner will be a perfect addition to your living room, rec room, or nursery. Featuring a tall back, wide padded arms and a thickly padded seat, you will enjoy sitting in total support. To raise the footrest, simply lean back and recline the chair. 
This recliner will easily become your favorite place to read, watch television or relax after a long days work.</p>
...
<td style="padding-left:50px">
  ...
  <p><span style="font-size:36px;font-family: 'Nunito', sans-serif;">  Our Price:</span><span style="font-size: 36px;font-family: 'Peralta', cursive;">Rs.4000</span></p>
 <p><span style="font-size:20px;font-family:'Nunito'">  List Price:</span><span style="font-size: 20px;font-family:'Nunito';text-decoration:line-through">Rs.4500</span></p>
<p><span style="font-size:20px;font-family:'Nunito'">  You Save:</span><span style="font-size: 20px;font-family:'Nunito';">Rs.500</span></p>
  ...
  <a href="ReclinersPage"><button type="button" class="btn btn-primary btn-xs">Back</button></a>
  </div>
